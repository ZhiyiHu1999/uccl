...
void reduceFloatSumScalar(float const* const* inputs, 
                          size_t inputCount,
                          float* output, 
                          size_t count) {
...
void reduceTwoFloatSumScalar(float const* const* inputs, 
                             size_t inputCount,
                             size_t inputStride, 
                             size_t firstOffset,
                             float* firstOutput, 
...
void reduceFloatSumAvx512(float const* const* inputs, 
                          size_t inputCount,
                          float* output, 
                          size_t count) {
  size_t element = 0;
...
__attribute__((target("avx512f")))
void reduceTwoFloatSumAvx512(float const* const* inputs, 
                             size_t inputCount,
                             size_t inputStride, 
                             size_t firstOffset,
                             float* firstOutput, 
...
#endif
  reduceTwoFloatSumScalar(inputs, 
                          inputCount, 
                          inputStride, 
                          firstOffset,
                          firstOutput, 
